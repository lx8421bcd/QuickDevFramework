...
public class FileApiFragment extends BaseFragment {
    ...
    public void OnCopyFolderSimple() {
        ...
        FileManager.copyFileOperate(FileManager.pathStringToFile(totalFilePath + File.separator + "FolderExample"),
                totalFilePath + File.separator + "CopyFolder").setFileSizeListener(new FileSizeListener() {
            @Override
            public void onStart() {}
