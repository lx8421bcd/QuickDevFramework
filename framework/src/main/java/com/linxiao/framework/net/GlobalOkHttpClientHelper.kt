...
object GlobalOkHttpClientHelper {
    ...
    val defaultClient by lazy {
        return@lazy getBuilder().buildWithHttpLogs()
    }
    ...
    fun OkHttpClient.Builder.buildWithHttpLogs(
        ...
        infoCatchInterceptor.httpInfoCatchListener = {
            if (shouldLogOut()) {
                it.logOut()
            }
        }
        this.addNetworkInterceptor(infoCatchInterceptor)
        return this.build()
    }
