...
public class SpanFormatter {
	...
	public static void setHighlightSpan(
			SpannableStringBuilder sourceSpan,
			String highlightText,
			int color
	) {
		if (sourceSpan.toString().contains(highlightText)) {
			int start = sourceSpan.toString().indexOf(highlightText);
			int end = start + highlightText.length();
			sourceSpan.setSpan(new ForegroundColorSpan(color), start, end, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
		}
	}
	...
	public static CharSequence getText(@StringRes int resId, Object... args) {
